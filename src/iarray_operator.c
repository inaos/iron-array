...
static ina_rc_t _iarray_gemm(iarray_context_t *ctx, iarray_container_t *a, iarray_container_t *b, iarray_container_t *c,
    ...
    for (_iarray_iter_matmul_init(iter); !_iarray_iter_matmul_finished(iter); _iarray_iter_matmul_next(iter)) {
        ...
        //printf("a_block: ");
        //for (int j = 0; j < a_size / typesize; ++j) {
        //    printf("%f ", ((float *) a_block)[j]);
        //}
        //printf("\n");
        ...
        //printf("b_block: ");
        //for (int j = 0; j < b_size / typesize; ++j) {
        //    printf("%f ", ((float *) b_block)[j]);
        //}
        //printf("\n");
        ...
        //printf("c_block: ");
        //for (int j = 0; j < c_size / typesize; ++j) {
        //    printf("%f ", ((float *) c_block)[j]);
        //}
        //printf("\n");

        if (c->catarr->storage == CATERVA_STORAGE_PLAINBUFFER) {
            c->catarr->buf = c_block; //TODO: Update this
            break;
        }
