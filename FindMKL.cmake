...
if(WIN32)
    ...
    if(MKL_MULTITHREADING)
        ...
        set(MKL_LIBS mkl_intel_lp64.lib mkl_core.lib mkl_intel_thread.lib iomp5.lib)
    else()
...
elseif(APPLE)
    ...
    if(MKL_MULTITHREADING)
        message("MKL Multithreading mode")
        set(MKL_LIBS libmkl_intel_lp64.a libmkl_core.a libmkl_intel_thread.a libiomp5.a)
    else()
        message("MKL Sequential mode")
    ...
    if(MKL_MULTITHREADING)
        message("MKL Multithreading mode")
        set(MKL_LIBS mkl_intel_lp64 mkl_core mkl_intel_thread iomp5)
    else()
        message("MKL Sequential mode")
