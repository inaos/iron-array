...
#define IARRAY_TRACE1(cat, fmt, __VA_ARGS__...) INA_TRACE1(cat, fmt " %s:%d", ##__VA_ARGS__, __FILE__, __LINE__)
#define IARRAY_TRACE2(cat, fmt, __VA_ARGS__...) INA_TRACE2(cat, fmt " %s:%d", ##__VA_ARGS__, __FILE__, __LINE__)
#define IARRAY_TRACE3(cat, fmt, __VA_ARGS__...) INA_TRACE3(cat, fmt " %s:%d", ##__VA_ARGS__, __FILE__, __LINE__)
