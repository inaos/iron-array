...
INA_TEST_FIXTURE(linalg_gemv, f_trans_plain) {
...
INA_TEST_FIXTURE(linalg_gemv, d_trans_plain) {
...
INA_TEST_FIXTURE(linalg_gemv, f_trans) {
...
INA_TEST_FIXTURE(linalg_gemv, d_trans) {
