...
elseif(APPLE)
    set(MKL_SEARCH_LIB libmkl_core.dylib)
    if(MKL_MULTITHREADING)
        message("MKL Multithreading mode")
        set(MKL_LIBS libmkl_intel_lp64.dylib libmkl_core.dylib libmkl_intel_thread.dylib)
    else()
        message("MKL Sequential mode")
        set(MKL_LIBS libmkl_intel_lp64.dylib libmkl_core.dylib libmkl_sequential.dylib)
    endif()
else() # Linux
