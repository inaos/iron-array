                                   ...
                                   const int64_t *bshape_b)
{
    ...
    INA_TEST_ASSERT_SUCCEED(iarray_chunk_advice(ctx, &dtshape_a, &store, low, high));
    ...
    INA_TEST_ASSERT_SUCCEED(iarray_chunk_advice(ctx, &dtshape_b, &store, low, high));
    ...
    INA_TEST_ASSERT_SUCCEED(iarray_chunk_advice(ctx, &dtshape_c, &store, low, high));
