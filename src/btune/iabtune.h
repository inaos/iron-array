/**********************************************************************
  ...
  Authors:
    ...
    Alberto Sabater <alberto3pt@gmail.com>

  Creation date: 2017-08-29

  See LICENSES/BTUNE.txt for details about copyright and rights to use.
***********************************************************************/
 ...
 * @authors Francesc Alted <francesc@blosc.org>, Alberto Sabater <alberto3pt@gmail.com>
 * @date 2017-12-01
*/
 ...
 * it starts with a hard readapt (cparams_hint false) and then repeats 10 soft readapts and
 * a hard readapt 3 times before stopping completely.
*/
static const btune_config BTUNE_CONFIG_DEFAULTS = {
  BTUNE_GBPS10, BTUNE_PERF_BALANCED, BTUNE_COMP_BALANCED, {0, 5, 2, BTUNE_STOP}, false};
 ...
 * blosc2_schunk * schunk = blosc2_new_schunk(cparams, dparams);
 * iabtune_init(&config, schunk->cctx, schunk->dctx);
 * @endcode
