...
if(WIN32)
    ...
    if(MKL_MULTITHREADING)
        ...
        set(MKL_LIBS mkl_intel_lp64.lib mkl_core.lib mkl_intel_thread.lib omp.lib)
    else()
...
elseif(APPLE)
    ...
    if(MKL_MULTITHREADING)
        message("MKL Multithreading mode")
        set(MKL_LIBS libmkl_intel_lp64.a libmkl_core.a libmkl_intel_thread.a libomp.a)
    else()
        message("MKL Sequential mode")
